...
?>
	<head>
		...
		<meta property="og:image"         content="ftp://<?php echo $global->getFtpServer().'/files/'.$dato['url']; ?>" />
	...
	<div class="row">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<?php
				echo '<img class="img-responsive" src="ftp://'.$global->getFtpServer().'/files/'.$dato['url'].'" id="imagen">';
